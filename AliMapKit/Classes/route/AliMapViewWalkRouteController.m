//
//  AliMapViewWalkRouteController.m
//  AliMapKit
//
...
@interface AliMapViewWalkRouteController ()<AMapSearchDelegate>{
...
@implementation AliMapViewWalkRouteController
...
- (void)viewDidLoad {
    ...
    AMapWalkingRouteSearchRequest *walkRouteRequest = [[AMapWalkingRouteSearchRequest alloc] init];
    walkRouteRequest.multipath = 1;
    walkRouteRequest.origin = [AMapGeoPoint locationWithLatitude:startCoordinate.latitude
                                                      longitude:startCoordinate.longitude];
    walkRouteRequest.destination = [AMapGeoPoint locationWithLatitude:destiCoordinate.latitude
                                                           longitude:destiCoordinate.longitude];
    
    
    //发起请求,开始POI的步行出行路线查询检索
    [_POISearchManager AMapWalkingRouteSearch:walkRouteRequest];
